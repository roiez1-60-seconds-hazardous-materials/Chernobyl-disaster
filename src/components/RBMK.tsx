  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: 1400, margin: '0 auto' }}>
        ...
        {/* Reactor legend — at the very end, collapsed by default */}
        {showLabels && (
          <details style={{ marginTop: 28 }}>
            <summary style={{
              cursor: 'pointer',
              padding: '12px 16px',
              background: 'linear-gradient(135deg, rgba(200,164,78,0.12), rgba(0,0,0,0.6))',
              border: `1px solid ${C.gold}55`,
              borderRadius: 10,
              fontSize: 14,
              color: C.gold,
              ...
              <span>◆ {t('מקרא רכיבי הכור (לחץ לפתיחה)', 'REACTOR LEGEND (click to expand)')}</span>
              ...
              <div style={{
                ...
                {[
                  ...
                  { n: 3, he_l: 'מוטות בקרה', en_l: 'Control Rods',
                    he_d: `${interpolatedState.rodPosition}% מוחדרים`,
                    en_d: `${interpolatedState.rodPosition}% inserted` },
