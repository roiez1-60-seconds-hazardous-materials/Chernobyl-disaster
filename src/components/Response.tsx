    ...
    <section id="response" style={{ padding: '60px 16px 30px', position: 'relative' }}>
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 28, position: 'relative' }}>
          ...
          <h2 className="section-title">{t('פעולות הכיבוי וההכלה', 'Containment & Response Operations')}</h2>
          <p className="section-subtitle">{t('600,000 ליקווידטורים · מבצע הצלה ההיסטורי הגדול בעולם', '600,000 liquidators · Largest containment operation in history')}</p>
